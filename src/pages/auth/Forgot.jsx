...
export default function Forgot() {
    return (
        <div>
            <h2 className="text-xl font-bold text-[#F4F3EF] mb-2 text-center uppercase tracking-tight">
                Recovery
            </h2>

            <p className="text-[11px] text-[#6B6E76] mb-8 text-center uppercase tracking-widest leading-relaxed">
            ...
            <p className="mt-8 text-center text-[11px] text-[#6B6E76] uppercase tracking-widest">
                Already Have an Account? <Link to="/login" className="text-[#A78BFA] font-bold hover:text-[#C9C2FF] hover:underline">Back to Login</Link>
            </p>
        </div>
    );
}